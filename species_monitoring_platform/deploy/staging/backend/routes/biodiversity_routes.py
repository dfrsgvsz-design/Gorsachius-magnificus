...
async def comprehensive_biodiversity(
    ...
    import main as _m
    from biodiversity_calculator import compute_comprehensive_indices
...
async def multi_site_biodiversity():
    ...
    import main as _m
    from biodiversity_calculator import compute_multi_site_beta
...
async def compare_sites(req: CompareSitesRequest):
    ...
    from biodiversity import compute_alpha_diversity, compute_beta_diversity
...
async def get_diversity_metrics(session_id: str):
    ...
    import main as _m
    from biodiversity import detection_summary
...
async def compute_functional_diversity(req: CompareSitesRequest):
    ...
    import main as _m
    from biodiversity import functional_diversity as fd_compute
...
async def beta_diversity_decomposition(req: CompareSitesRequest):
    ...
    from biodiversity import turnover_nestedness, whittaker_beta
...
async def compute_conservation_priority(req: CompareSitesRequest):
    ...
    import main as _m
    from biodiversity import conservation_priority_score
