...
def load_engine(args):
    ...
    if args.onnx:
        ...
        import torch
        from cnn_model_v7 import ConvNeXtBirdV7, ConvNeXtBirdV7Student
...
def analyze_file(filepath: Path, engine_type: str, engine, args) -> List[dict]:
    ...
    import numpy as np
    from cnn_model_v7 import compute_dual_channel_mel
...
def cmd_export(args):
    ...
    import torch
    from cnn_model_v7 import create_model_v7, export_to_onnx
